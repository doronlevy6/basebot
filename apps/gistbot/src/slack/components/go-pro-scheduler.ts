...
export const GoProSchedulerText = (channelIds: string[], limit: number) => {
  ...
  return `Our free plan supports up to ${limit} channel summaries. ${channels} were not included in theGist. Upgrade to pro in order to see them in the next summary. `;
};
